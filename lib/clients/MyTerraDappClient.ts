...
export interface MyTerraDappReadOnlyInterface {
  contractAddress: string;
  getCountQuery: () => Promise<CountResponse>;
}
export class MyTerraDappQueryClient implements MyTerraDappReadOnlyInterface {
  client: LCDClient;
  contractAddress: string;
...
export interface MyTerraDappInterface extends MyTerraDappReadOnlyInterface {
  contractAddress: string;
...
export class MyTerraDappClient extends MyTerraDappQueryClient implements MyTerraDappInterface {
  client: LCDClient;
